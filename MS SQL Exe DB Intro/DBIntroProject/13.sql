...
CREATE TABLE Movies (
  ...
  MovieNotes NVARCHAR(max)
)

INSERT INTO Directors(DirectorName, DirectorNotes) VALUES
...
INSERT INTO Genres(GenreName, GenreNotes) VALUES
('Action', 'Action movie'),
('Comedy', 'Comedy movie'),
('Drama', 'Drama movie'),
...
INSERT INTO Categories(CategoryName, CategoryNotes) VALUES
...
INSERT INTO Movies(Title, DirectorId, CopyrightYear, [Length], GenreId, CategoryId, Rating, MovieNotes) Values
